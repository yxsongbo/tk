...
CREATE INDEX idx_study_notes_student ON study_notes(student_id);
CREATE INDEX idx_study_notes_question_text ON study_notes(question_text);
CREATE INDEX idx_study_note_likes_note ON study_note_likes(note_id);
CREATE INDEX idx_study_note_likes_student ON study_note_likes(student_id);
